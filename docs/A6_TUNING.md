...
**During one-click / inertia tuning:** `a6_servo_tune.relax_following_error_for_tuning()`
raises 6065 to **2.0 mm / 2.0°** for stimulus moves, then
`restore_following_error_run()` puts the production **0.5** window back. See
[ONE_CLICK_TUNING.md](ONE_CLICK_TUNING.md#safety-model).
