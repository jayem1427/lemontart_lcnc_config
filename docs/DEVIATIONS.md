...
**For production:** tighten per axis after drive tuning and confirm no false trips under cutting loads. Drive-side windows (SDO 6065/6066 ≈ **0.5 mm / 0.5° / 250 ms**) are separate — see [A6_TUNING.md](A6_TUNING.md) and [CiA 402 following error](https://linuxcnc.org/docs/html/config/ini-config.html#sub:joint-section). One-click / inertia tuning temporarily raises 6065 to **2.0** during stimulus moves, then restores the production window.
