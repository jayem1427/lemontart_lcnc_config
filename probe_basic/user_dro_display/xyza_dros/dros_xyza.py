...
class UserDRO(QWidget):
    ...
    def _install_set_z_control(self):
        """Populate the SET Z entry + button container from the UI file."""
        ...
        self.set_z_entry.setMaximumHeight(40)
        self.set_z_entry.returnPressed.connect(self._set_wco_z)

        self.set_z_button = QPushButton("SET Z")
        self.set_z_button.setMinimumSize(60, 40)
        self.set_z_button.setMaximumHeight(40)
